...
// all environments
server.set('port', process.env.PORT || 443);
...
//start server
var options = {
  key: fs.readFileSync('/root/ssl/shocola.jp.key'),
  cert: fs.readFileSync('/root/ssl/153.122.67.9_shocola.jp.cer'),
...
https.createServer(options, server).listen(443, function(){
	console.log('HTTPS STARTED PORT 443');
});
