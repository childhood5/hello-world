...
function normalize(fields, params) {
  ...
  fields.forEach(function(f) {
    var given = params[f];
    result[f] = _.isUndefined(given) ? null : given;
  });
  return result;
}
...
function ChargeRequestRefund(params) {
  params = normalize(this.fields, params);
  Object.defineProperty(this, '__attrs', { value: params });
}

ChargeRequestRefund.prototype.fields = ['id', 'amount', 'uuid'];

Object.defineProperty(ChargeRequestRefund.prototype, 'id', {
  get: function() { return this.__attrs['id']; },
...
Object.defineProperty(ChargeRequestRefund.prototype, 'amount', {
  get: function() { return this.__attrs['amount']; },
...
Object.defineProperty(ChargeRequestRefund.prototype, 'uuid', {
  get: function() { return this.__attrs['uuid']; },
...
ChargeRequestRefund.prototype.requestBody = function chargeRequestRefundRequestBody() {
  var result = {};
  copyIfExists(this.__attrs, result, 'amount', 'requestBody');
  copyIfExists(this.__attrs, result, 'uuid', 'requestBody');
  return result;
...
ChargeRequestRefund.prototype.queryParams = function chargeRequestRefundQueryParams() {
  var result = {};
  return result;
};

ChargeRequestRefund.prototype.toString = ChargeRequestRefund.prototype.inspect = function chargeRequestRefundToString() {
...
ChargeRequestRefund.create = function createChargeRequestRefund(params) {
  if (params === null || params === undefined) {
    return noConversionError('ChargeRequestRefund', params);
  }
  if (params instanceof ChargeRequestRefund) {
    return params;
  }

  if (_.isObject(params) && params instanceof ChargeResponse) { return new ChargeRequestRefund({'id': params.id}); }
  if (_.isString(params)) { return new ChargeRequestRefund({'id': params}); }
  if (_.isPlainObject(params)) { return new ChargeRequestRefund(params); }
  return noConversionError('ChargeRequestRefund', params);
};
module.exports.ChargeRequestRefund = ChargeRequestRefund;
...
ChargeListRequest.prototype.fields = ['count', 'offset', 'created', 'customer', 'recursion', 'shop', 'captured', 'paid'];
...
Object.defineProperty(ChargeListRequest.prototype, 'captured', {
  get: function() { return this.__attrs['captured']; },

  set: function(value) {
    this.__attrs['captured'] = value;
  },
  configurable: false,
  enumerable: true
});

Object.defineProperty(ChargeListRequest.prototype, 'paid', {
  get: function() { return this.__attrs['paid']; },

  set: function(value) {
    this.__attrs['paid'] = value;
  },
  configurable: false,
  enumerable: true
});
...
ChargeListRequest.prototype.queryParams = function chargeListRequestQueryParams() {
  ...
  copyIfExists(this.__attrs, result, 'captured', 'queryParams');
  copyIfExists(this.__attrs, result, 'paid', 'queryParams');
  return result;
};
...
TokenRequestCreate.prototype.fields = ['card', 'customer', 'uuid'];
...
Object.defineProperty(TokenRequestCreate.prototype, 'customer', {
  get: function() { return this.__attrs['customer']; },
...
function ShopRequestAlterStatus(params) {
  params = normalize(this.fields, params);
  Object.defineProperty(this, '__attrs', { value: params });
}

ShopRequestAlterStatus.prototype.fields = ['id', 'status'];

Object.defineProperty(ShopRequestAlterStatus.prototype, 'id', {
  get: function() { return this.__attrs['id']; },
...
Object.defineProperty(ShopRequestAlterStatus.prototype, 'status', {
  get: function() { return this.__attrs['status']; },

  set: function(value) {
    this.__attrs['status'] = value;
  },
  configurable: false,
  enumerable: true
});
...
ShopRequestAlterStatus.prototype.requestBody = function shopRequestAlterStatusRequestBody() {
  var result = {};
  copyIfExists(this.__attrs, result, 'status', 'requestBody');
  return result;
};

ShopRequestAlterStatus.prototype.queryParams = function shopRequestAlterStatusQueryParams() {
  var result = {};
  return result;
};

ShopRequestAlterStatus.prototype.toString = ShopRequestAlterStatus.prototype.inspect = function shopRequestAlterStatusToString() {
...
ShopRequestAlterStatus.create = function createShopRequestAlterStatus(params) {
  if (params === null || params === undefined) {
    return noConversionError('ShopRequestAlterStatus', params);
  }
  if (params instanceof ShopRequestAlterStatus) {
    return params;
  }

  if (_.isObject(params) && params instanceof ShopResponse) { return new ShopRequestAlterStatus({'id': params.id}); }
  if (_.isString(params)) { return new ShopRequestAlterStatus({'id': params}); }
  if (_.isPlainObject(params)) { return new ShopRequestAlterStatus(params); }
  return noConversionError('ShopRequestAlterStatus', params);
};
module.exports.ShopRequestAlterStatus = ShopRequestAlterStatus;
